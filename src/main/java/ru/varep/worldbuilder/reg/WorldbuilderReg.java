...
public final class WorldbuilderReg {
    ...
    public static final DeferredHolder<MapCodec<? extends BiomeSource>, MapCodec<? extends BiomeSource>> MAP_REGIONES =
            BIOME_SOURCE_TYPES.register("map_regions", () -> RegionBiomeSource.CODEC);
}
